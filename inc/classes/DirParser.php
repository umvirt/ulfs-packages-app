...
class DirParser
{
     ...
     */
    public function checkfilename($file, $patterns)
    {
        $chk = false;
     ...
     */
    public function parsedirtree($subdir, &$files, $ignorefiles, &$size, $md5 = false, $filescnt = 0, $debug = false)
    {
                ...
                while (($file = readdir($dh)) !== false) {
                    ...
                    if (($file != ".") and ($file != "..") and !$this->checkfilename($file, $ignorefiles)) {
                        ...
                        if (is_dir($filepath)) {
                            ...
                            $fileinfo = ["name" => $file, "path" => $subdir, "mtime" => filemtime($filepath), "size" => filesize($filepath)];
